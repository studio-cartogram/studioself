...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _barba = __webpack_require__(376);
	...
	var _Curtain = __webpack_require__(379);

	var _Curtain2 = _interopRequireDefault(_Curtain);

	var _removeClasses = __webpack_require__(385);

	var _removeClasses2 = _interopRequireDefault(_removeClasses);

	var _imagesloaded = __webpack_require__(386);

	var _imagesloaded2 = _interopRequireDefault(_imagesloaded);

	var _addListenerMulti = __webpack_require__(388);

	var _addListenerMulti2 = _interopRequireDefault(_addListenerMulti);
	...
	var App = function App() {
	  ...
	  this.init = function () {
	    _this.curtainEl = document.getElementById('js-curtain');
	    _this.curtain = new _Curtain2.default(_this.curtainEl);
	    ...
	    _barba2.default.Dispatcher.on('linkClicked', function (el) {
	      var currentStatus = _barba2.default.HistoryManager.currentStatus();
	      // this.returnTo = (el ? el.offsetTop : 0)
	      _this.returnTo = el ? el.offsetTop : 0;
	      if (currentStatus && currentStatus.namespace === 'home') {
	        document.body.setAttribute('data-scroll-start', _this.returnTo);
	      }
	    });

	    _barba2.default.Dispatcher.on('transitionCompleted', function (currentStatus, ps) {
	  ...
	  this.initTransitions = function () {
	    ...
	    _this.Transition = _barba2.default.BaseTransition.extend({
	      start: function start() {
	        _promise2.default.all([this.newContainerLoading]).then(this.showNewPage.bind(this));
	      },
	  ...
	  this.initSaver = function () {
	    return (0, _addListenerMulti2.default)(document.body, 'mousemove touchmove', (0, _debounce2.default)(_this.mouseMove, 60));
	  };
	  ...
	  this.mouseMove = function (e) {
	    ...
	    if (_this.saverShown) {
	      _this.curtain.hide();
	      _this.saverShown = false;
	    }

	    _this.cursorTimer = setTimeout(function () {
	      _this.curtain.show();
	      _this.saverShown = true;
	    }, _config.SAVER_WAIT_DURATION);
	  };

	  (0, _log2.default)('starting app');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(365),
	    ...
	    toNumber = __webpack_require__(369);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(365),
	    isSymbol = __webpack_require__(370);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(372),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _once = __webpack_require__(384);
	...
	var Curtain = function () {
	  function Curtain(el) {
	    ...
	    setTimeout(function () {
	      return document.addEventListener('scroll', _this.hide);
	    }, 100);
	  }

	  (0, _createClass3.default)(Curtain, [{
	    key: 'isCurtainShown',
	    value: function isCurtainShown() {
...
/***/ (function(module, exports) {
	...
	exports.default = addListenerMulti;
...
/***/ (function(module, exports) {
	...
	exports.SAVER_WAIT_DURATION = SAVER_WAIT_DURATION;
