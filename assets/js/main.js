...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _barba = __webpack_require__(364);
	...
	var _Curtain = __webpack_require__(367);
	...
	var _imagesloaded = __webpack_require__(381);
	  ...
	  this.initTransitions = function () {
	    ...
	    _this.Transition = _barba2.default.BaseTransition.extend({
	      start: function start() {
	        ...
	        this.newContainerLoading, this.showCurtain(), _scrollTop().finished]).then(this.showNewPage.bind(this));
	      },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Curtain = function Curtain(el) {
	  ...
	  this.show = function (onComplete) {
	    ...
	    (0, _once2.default)(_this.swoosh, 'animationend', function () {
